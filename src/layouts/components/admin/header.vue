        ...
        <div class="topbar d-flex align-items-center">
          <nav class="navbar navbar-expand">
            <div class="topbar-logo-header">
              <div class="">
                <img
                  src="../../../assets/assets_admin/images/logo-icon.png"
                  class="logo-icon"
                  alt="logo icon"
                />
              </div>
                    ...
                    <div class="header-message-list">
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-1.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-2.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-3.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-4.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-5.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-6.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-7.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-8.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-9.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-10.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
                      ...
                      <a class="dropdown-item" href="javascript:;">
                        <div class="d-flex align-items-center">
                          <div class="user-online">
                            <img
                              src="../../../assets/assets_admin/images/avatars/avatar-11.png"
                              class="msg-avatar"
                              alt="user avatar"
                            />
                          </div>
